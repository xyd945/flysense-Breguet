...
public class MediaPlayer extends Activity implements View.OnClickListener {
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(MediaPlayer.this, OrientationHelper.VERTICAL,false);
        ...
        //Init Loading Dialog
        mLoadingDialog = new ProgressDialog(MediaPlayer.this);
        mLoadingDialog.setMessage("Please wait");
        mLoadingDialog.setCanceledOnTouchOutside(false);
        mLoadingDialog.setCancelable(false);

        //Init Download Dialog
        mDownloadDialog = new ProgressDialog(MediaPlayer.this);
    ...
    private void setResultToToast(final String result) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(MediaPlayer.this, result, Toast.LENGTH_SHORT).show();
            }
        });
    }
