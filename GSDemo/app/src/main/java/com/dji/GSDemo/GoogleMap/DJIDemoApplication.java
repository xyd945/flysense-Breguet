...
public class DJIDemoApplication extends Application {
    ...
    // this part of code is copied from FPVDemoApplication to getCameraInstance()
    ...
    public static boolean isCameraModuleAvailable() {
        return isProductModuleAvailable() &&
                (null != DJIDemoApplication.getProductInstance().getCamera());
    }

    public static boolean isPlaybackAvailable() {
        return isCameraModuleAvailable() &&
                (null != DJIDemoApplication.getProductInstance().getCamera().getPlaybackManager());
    }
    ////////////////////////////////////////////////////////////////////////////////
